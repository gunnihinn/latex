...
\let\oldmp\marginpar
\def\marginpar#1{\oldmp{\footnotesize #1}}
...
\marginpar{GM: What's a $n_0$-manifold?}
with $c_1(X_0)=0$ %and let $\tilde\omega_0$ be a K\"ahler ricci flat metric on $X_0$.
...
\marginpar{GM: Any compact complex submanifold of a compact K\"ahler manifold is homologically nontrivial}
...
Let $X_0$ be a compact K\"ahler $n_0$-manifold with $c_1(X_0)\leq 0$, %and let $\tilde\omega_0$ be a K\"ahler ricci flat metric on $X_0$.
...
%The curve with equation $\left(b+a-\tfrac{1}{s_0}\right)\left(b-a+\tfrac{2}{s_0}\right)=\tfrac{5}{4s_0^2}$ is an hyperbola with center $\left(\tfrac{3}{2s_0},-\tfrac{1}{2s_0}\right)$ and asymptotes the lines $b=-a+\tfrac{1}{s_0}$ and $b=a-\tfrac{2}{s_0}$. We see that for $b=a-\tfrac{1}{s_0}$ (which corresponds to a form in the K\"ahler cone if $a>\tfrac{1}{s_0}$), the inequality is satisfied for any $a$ big enough. Hence we have no upper bound on $a$ or $b$.
...
\marginpar{GM: I mean, you can prove that if you want, but complex geometers know this. A short proof notes that $\alpha \wedge \omega^{n-1} = \Lambda \alpha$, where $\Lambda$ is the adjoint of the Lefschetz operator, and $\Lambda \alpha$ is known to be the trace of $\alpha$ wrt $\omega$.}
...
%This is a purely pointwise statement, thus we can work in $\mathbb{C}^n$ with its standard K\"ahler form $\omega=\frac{i}{2}\sum_{k=1}^n dz_k\wedge d\bar z_k$ and write $\alpha=\frac{i}{2}\sum_{k,l}\alpha_{k\bar l}dz^k\wedge d\bar{z}^l$ for some reals $a_{kl}$, recall that $\omega^n=\frac{i^{n}}{2^{n}} n!\bigwedge_kdz^k\wedge d\bar{z}^k$. We also have:
