...
One would think it would be nice to be able to say what the inner product on the quotient is. We can write it down and find out that it isn't so much.1
...
If this operation should be called anything, it is clearly a \emph{reformation} of the original space, as it removes all the degeneracy from the Hermitian form. As the first of many applications, we'll study adjoints of morphisms.
